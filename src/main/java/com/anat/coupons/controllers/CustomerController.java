...
//		validateGetCustomerByCustomerId(customerId);
	...
	public CustomerEntity login(String customerName, String customerPassword) throws ApplicationException {
...
//--------------------------------------------------------------------validations-------------------------------------------------------------------------
	...
	private void validateUpdateCustomer(CustomerEntity customer) throws ApplicationException {
		...
		CustomerEntity oldCustomer = this.customerDao.getCustomerByCustomerId(custId);
...
//	}
	...
	private void validateLogin(String customerName, String customerPassword) throws ApplicationException {
		CustomerEntity customer = this.customerDao.checkLogin(customerName, customerPassword);
		if (customer == null) {
