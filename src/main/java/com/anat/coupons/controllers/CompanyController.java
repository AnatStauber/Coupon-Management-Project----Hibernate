...
public class CompanyController {
	...
	public CompanyEntity login(String companyName, String companyPassword) throws ApplicationException {
...
//--------------------------------------------------------------------validations-------------------------------------------------------------------------
	...
	private void validateUpdateCompany(CompanyEntity company) throws ApplicationException {
		...
		// extracting the company before the update
		CompanyEntity oldCompany = this.companyDao.getCompanyByCompanyId(companyId);
